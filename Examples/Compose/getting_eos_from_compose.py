...
if __name__ == "__main__":
    ...
    limited_thermo.to_csv("rdf1p7_chemical_equalibrium_thermo.csv", index=False)
    cold_eos = tmcomp.find_1d_eos_by_taking_T_equal_minT(limited_thermo, nb, t)
    ns_thermo, nb_ns, t, yq  = tmcomp.read_compose_3d_table(thermo_ns_path, nb_ns_path, t_path, yq_path)
    ...
    cgs_eos.to_csv(f"{prefix}_cgs.csv")
